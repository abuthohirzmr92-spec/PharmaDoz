  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-neutral-900 dark:text-neutral-50">Buat Paket Baru</h1>
        ...
        <fieldset disabled={isLoading} className="space-y-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              ...
              <input type="text" value={name} onChange={(e) => setName(e.target.value)} placeholder="premium_plus"
            ...
            <div>
              ...
              <input type="text" value={label} onChange={(e) => setLabel(e.target.value)} placeholder="Premium Plus"
                className="mt-1 block w-full rounded-lg border border-neutral-300 bg-white px-3 py-2 text-sm focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-50" required />
            </div>
          </div>
